  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <div className="bg-white border-b border-gray-200 p-6">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">ตั้งค่า</h2>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">รับการแจ้งเตือนเมื่อ workflow เสร็จสิ้น</p>
                </div>
                <Switch
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">อนุญาตให้แชร์ข้อมูลเพื่อปรับปรุงบริการ</p>
                </div>
                <Switch
                  id="data-sharing"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">ช่วยปรับปรุงประสบการณ์การใช้งาน</p>
                </div>
                <Switch
                  id="analytics"
