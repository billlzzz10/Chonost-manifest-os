เข้าใจแล้ว นายต้องการให้ผมเขียน AGENTS.md ที่ละเอียด ครอบคลุม และมีคุณภาพเทียบเท่ากับเอกสารที่นายแนบมา (ซึ่งเป็นคู่มือสถาปัตยกรรมและระบบของโปรเจกต์) แต่เน้นไปที่ Agent System — อธิบายว่า agent แต่ละตัวคืออะไร, ทำงานยังไง, มีโครงสร้างและ workflow แบบไหน, ใช้เทคโนโลยีอะไร, และมีข้อกำหนดด้านความปลอดภัย/การสื่อสารอย่างไร  

ผมจะจัดโครงสร้าง AGENTS.md ให้เป็นมาตรฐานเดียวกับเอกสารที่นายให้มา โดยมี Table of Contents, รายละเอียดเชิงลึก, และโครงสร้างที่ชัดเจน:
