...
class AIProviderStrategy(ABC):
    ...
    async def generate_response(self, messages: List[Dict[str, str]], **kwargs) -> Dict[str, Any]:
        """
        Generates a response from the AI provider asynchronously.
    ...
    async def embed(self, text: str, model: Optional[str] = None) -> Dict[str, Any]:
        """
        Generates an embedding for a given text asynchronously.
...
class OpenAIStrategy(AIProviderStrategy):
    ...
    async def generate_response(self, messages: List[Dict[str, str]], **kwargs) -> Dict[str, Any]:
        """Generates a response using the OpenAI API asynchronously."""
        try:
    ...
    async def embed(self, text: str, model: Optional[str] = None) -> Dict[str, Any]:
        """Generates an embedding using the OpenAI API asynchronously."""
        try:
...
class OllamaStrategy(AIProviderStrategy):
    ...
    async def generate_response(self, messages: List[Dict[str, str]], **kwargs) -> Dict[str, Any]:
        """
        Generates a response from an Ollama server asynchronously.
    ...
    async def embed(self, text: str, model: Optional[str] = None) -> Dict[str, Any]:
        """Generates an embedding using the Ollama API asynchronously."""
        try:
...
class GoogleStrategy(AIProviderStrategy):
    ...
    async def embed(self, text: str, model: Optional[str] = None) -> Dict[str, Any]:
        """Generates an embedding using the Google Generative AI API asynchronously."""
        try:
...
class UnifiedAIClient:
    ...
    def _init_strategies(self):
        ...
        # Note: These need API keys from config to be fully functional.
        if self.config.google_api_key:
            self._strategies['google'] = GoogleStrategy(api_key=self.config.google_api_key)
        else:
            self._strategies['google'] = OpenRouterStrategy() # Fallback or error
    ...
    async def generate_response(self, provider: str, messages: List[Dict[str, str]], **kwargs) -> Dict[str, Any]:
        """
        Generates a response using a specified provider asynchronously.
    ...
    async def embed(self, provider: str, text: str, model: Optional[str] = None) -> Dict[str, Any]:
        """
        Generates an embedding using a specified provider asynchronously.
