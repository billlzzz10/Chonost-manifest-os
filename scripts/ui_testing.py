...
try:
    ...
    # Create a mock requests module to avoid import errors
    class MockRequests:
        @staticmethod
        def get(*args, **kwargs):
            raise ImportError("requests module not available - please install with 'pip install requests'")
    
    # Replace requests with mock if not available
    ...
    def test_component_availability(self):
        ...
        for component in components_to_test:
            try:
                ...
                if component in components_to_test:
